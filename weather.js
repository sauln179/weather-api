var apiKey = "05b60efa5b3c74a385f7ba1033c9dc6a";

// current date
let $cityDate = moment().format("llll");
$("#currentdate").text($cityDate);

//click listner to start functions to search city, and will save city
...
function citysearch() {
    ...
    $.ajax({
        ...
        $.ajax({
            ...
            $uvIndex.text($uv);
            $uvIndex.blur();
            //Using if statements to add, or remove buttons
            if ($uv <= 2) {
